...
def process_article(selected_article):
    ...
    developer_msg_summary = (
        "You are an expert news summarizer tasked with condensing an article into a concise summary of 140 words or fewer in an easy-to-read format. "
        ...
        "3. Keep the overall summary concise, limiting it to 140 words or fewer, but no less than 130 words. "
